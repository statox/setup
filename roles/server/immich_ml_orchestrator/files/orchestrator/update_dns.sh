...
# Get the current IP of the running Fargate task and update
# the immich-ml.statox.fr DNS with this IP
#
# Since we use only once IP in the DNS name we should only
# spawn once instance of the Fargate task
#
...
#
# TODO: This script should be merged into ./run.sh to avoid code duplication
